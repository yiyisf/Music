...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MediaDescriptionCompat descriptionCompat = getIntent().getParcelableExtra("metadata");

        mVisible = true;
        mControlsView = findViewById(R.id.fullscreen_content_controls);
        mContentView = findViewById(R.id.fullscreen_content);

//        if((ImageView)mContentView!=null){
            cache = AlbumArtCache.getInstance();
            cache.fetchFromUrl(descriptionCompat.getIconUri().toString(), new AlbumArtCache.FetchListener() {
                @Override
...
//        if(((AppCompatImageView)mContentView)!=null) {
//            Glide.with(this)
//                    .load(descriptionCompat.getIconUri())
//                    .into((AppCompatImageView)mContentView);
//        }
